...
# Don't forget to give this script the correct privileges to be able to run.
...
location_id = "067b4b9077b753034e5f49bfccb0d89ff6fef2a8a6f167ad33c39b60d7c08dfa"
...
out_data = {
    "text": f"<span color='#E9502B' size='14000'>{icon}</span> {temp}",
    "alt": status,
